...
def loop2(anzZeitschritte, anzTeilchen, anzSpinup, termination, weltlinien, Jz, beta, gs_ratio, gd_ratio):
...
for n in xrange(1,anzMarkovZeit):
    ...
    # Loop finden
    x,y,l,k,update = loop2(anzZeitschritte, anzTeilchen, anzSpinup, termination, weltlinien, Jz, beta, gs_ratio, gd_ratio)
...
mean_E /= (anzTeilchen*anzZeitschritte)
mean_E -= Jz/4
...
plt.plot(anzTeilchen*anzZeitschritte - meanNd - meanNs, '-k', label='S1')
